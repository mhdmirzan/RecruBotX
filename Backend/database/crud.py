...
async def create_screening_result(
    ...
    result = {
        ...
        "skills_match": float(result_data.get("skills_match", 0)),
        "experience_match": float(result_data.get("experience_match", 0)),
        "education_match": float(result_data.get("education_match", 0)),
