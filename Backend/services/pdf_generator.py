...
def create_evaluation_pdf(evaluation_data: dict, company_name: str = None) -> BytesIO:
    ...
    elements.append(Paragraph(f"Generated by Interveuu | {company_name or 'Your Company'}", subtitle_style))
    ...
    elements.append(Paragraph(
        f"This report was generated by Interveuu on {datetime.now().strftime('%B %d, %Y at %I:%M %p')}",
        footer_style
    ))
    elements.append(Paragraph(
        f"© {datetime.now().year} Interveuu. All rights reserved. | Confidential Document",
        footer_style
    ))
